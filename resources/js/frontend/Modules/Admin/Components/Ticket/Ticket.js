                ...
                <div className="col-sm-12">
                    <div className="card">
                        <div className="card-header">
                            {!onAdd ? (
                                <h4 className="card-title">Danh sách vé máy bay
                                    <button
                                ...
                                <h4 className="card-title" style={{marginLeft:"20px"}}>Thêm vé máy bay
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <Link to={`/admin/tickets/${item.id}`}>
                                                                <button className="btn btn-primary" style={{float:"right", marginRight:"-18px"}}>View</button>
                                                            </Link>
                                                        </td>
                                                    </tr>
                                                );
